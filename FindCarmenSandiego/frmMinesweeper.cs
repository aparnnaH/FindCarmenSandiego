...
namespace minesweeper_puzzle
{
	public partial class frmMinesweeper : Form
	{
		...
		{
			btn[row, column].BackgroundImage = FindCarmenSandiego.Properties.Resources.bomb_clicked;
			for (int i = 0; i <= 8; i++)
			{
				for (int j = 0; j <= 8; j++)
				{
					...
					{
						btn[i, j].BackgroundImage = FindCarmenSandiego.Properties.Resources.bomb_not_clicked;
					}
					if (btn[i, j].Tag.ToString() != "bomb" && flag[i,j] == 1)
					{
						btn[i, j].BackgroundImage = FindCarmenSandiego.Properties.Resources.bomb_wrong_click;
					}
		...
		private void RevealNum(int index1, int index2)
		{
			if (btn[index1, index2].Tag.Equals(1))
				btn[index1, index2].BackgroundImage = FindCarmenSandiego.Properties.Resources.one;
			else if (btn[index1, index2].Tag.Equals(2))
				btn[index1, index2].BackgroundImage = FindCarmenSandiego.Properties.Resources.two;
			else if (btn[index1, index2].Tag.Equals(3))
				btn[index1, index2].BackgroundImage = FindCarmenSandiego.Properties.Resources.three;
			else if (btn[index1, index2].Tag.Equals(4))
				btn[index1, index2].BackgroundImage = FindCarmenSandiego.Properties.Resources.four;
			else if (btn[index1, index2].Tag.Equals(5))
				btn[index1, index2].BackgroundImage = FindCarmenSandiego.Properties.Resources.five;
			else if (btn[index1, index2].Tag.Equals(6))
				btn[index1, index2].BackgroundImage = FindCarmenSandiego.Properties.Resources.six;
			else if (btn[index1, index2].Tag.Equals(7))
				btn[index1, index2].BackgroundImage = FindCarmenSandiego.Properties.Resources.seven;
			else if (btn[index1, index2].Tag.Equals(8))
				btn[index1, index2].BackgroundImage = FindCarmenSandiego.Properties.Resources.eight;
		}
		...
		private void Flag(int row, int column)
		{
			...
			{
				flag[row, column] += 1;
				btn[row, column].BackgroundImage = FindCarmenSandiego.Properties.Resources.flag;
			}
		...
		private void btnInsructions_Click(object sender, EventArgs e)
		{
