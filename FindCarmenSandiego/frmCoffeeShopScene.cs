...
namespace Coffee_shop_Scene
{
	public partial class frmCoffeeShopScene : Form
	{
		...
		private void tmrCoffeeShop_Tick(object sender, EventArgs e)
		{
			...
			if (seconds == 3)
			{
				this.BackgroundImage = FindCarmenSandiego.Properties.Resources.coffe_shop_table;
			...
			{
				SplashScreen_FP.SplashScreen.India = true;
		...
		private void picMainImage_Click(object sender, EventArgs e)
		{
