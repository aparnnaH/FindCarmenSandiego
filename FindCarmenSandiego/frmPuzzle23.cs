    ...
    public partial class frmPuzzle23 : Form
    {
        ...
        private void btnGO_Click(object sender, EventArgs e)
        {
            ...
            if (pbA71.Tag.ToString().IndexOf("d") != -1 && pbA73.Tag.ToString().IndexOf("d") != -1 && pbA76.Tag.ToString().IndexOf("d") != -1)
            {
                ...
                pbA71.Image = FindCarmenSandiego.Properties.Resources.RedTurn;
                ColourRotate(pbA71);
                strGreenP = "6,2," + pbA73.Tag.ToString()[0];
                pbA73.Image = FindCarmenSandiego.Properties.Resources.GreenTurn;
                ColourRotate(pbA73);
                strBlueP = "6,5," + pbA76.Tag.ToString()[0];
                pbA76.Image = FindCarmenSandiego.Properties.Resources.BlueTurn;
                ColourRotate(pbA76);
                tmrTick.Start();
            }
            else
        ...
        private void tmrTick_Tick(object sender, EventArgs e)
        {
            ...
            if (Edge(strRedP))
            {
                switch (strRedP[4])
                {
                    case 'u': GoUp(ref strRedP, FindCarmenSandiego.Properties.Resources.RedTurn, FindCarmenSandiego.Properties.Resources.RedForward); break;
                    case 'd': GoDown(ref strRedP, FindCarmenSandiego.Properties.Resources.RedTurn, FindCarmenSandiego.Properties.Resources.RedForward); break;
                    case 'l': GoLeft(ref strRedP, FindCarmenSandiego.Properties.Resources.RedTurn, FindCarmenSandiego.Properties.Resources.RedForward); break;
                    case 'r': GoRight(ref strRedP, FindCarmenSandiego.Properties.Resources.RedTurn, FindCarmenSandiego.Properties.Resources.RedForward); break;
                    default:
                        break;
                }
            }
            ...
            if (Edge(strGreenP))
            {
                switch (strGreenP[4])
                {
                    case 'u': GoUp(ref strGreenP, FindCarmenSandiego.Properties.Resources.GreenTurn, FindCarmenSandiego.Properties.Resources.GreenForward); break;
                    case 'd': GoDown(ref strGreenP, FindCarmenSandiego.Properties.Resources.GreenTurn, FindCarmenSandiego.Properties.Resources.GreenForward); break;
                    case 'l': GoLeft(ref strGreenP, FindCarmenSandiego.Properties.Resources.GreenTurn, FindCarmenSandiego.Properties.Resources.GreenForward); break;
                    case 'r': GoRight(ref strGreenP, FindCarmenSandiego.Properties.Resources.GreenTurn, FindCarmenSandiego.Properties.Resources.GreenForward); break;
                    default:
                        break;
                }
            }
            ...
            if (Edge(strBlueP))
            {
                switch (strBlueP[4])
                {
                    case 'u': GoUp(ref strBlueP, FindCarmenSandiego.Properties.Resources.BlueTurn, FindCarmenSandiego.Properties.Resources.BlueForward); break;
                    case 'd': GoDown(ref strBlueP, FindCarmenSandiego.Properties.Resources.BlueTurn, FindCarmenSandiego.Properties.Resources.BlueForward); break;
                    case 'l': GoLeft(ref strBlueP, FindCarmenSandiego.Properties.Resources.BlueTurn, FindCarmenSandiego.Properties.Resources.BlueForward); break;
                    case 'r': GoRight(ref strBlueP, FindCarmenSandiego.Properties.Resources.BlueTurn, FindCarmenSandiego.Properties.Resources.BlueForward); break;
                    default:
                        break;
                }
            }
        ...
        private void CrossReColour()
        {
            switch (strCrossColour[1])
            {
                case 'e':
                    ...
                    {
                        case 'e': pbA25.Image = FindCarmenSandiego.Properties.Resources.EmptyCrossEmpty; break;
                        case 'r': pbA25.Image = FindCarmenSandiego.Properties.Resources.EmptyCrossRed; break;
                        case 'g': pbA25.Image = FindCarmenSandiego.Properties.Resources.EmptyCrossGreen; break;
                        case 'b': pbA25.Image = FindCarmenSandiego.Properties.Resources.EmptyCrossBlue; break;
                        default:
                            break;
                    } break;
                ...
                case 'r':
                    switch (strCrossColour[0])
                    {
                        case 'e': pbA25.Image = FindCarmenSandiego.Properties.Resources.RedCrossEmpty; break;
                        case 'r': pbA25.Image = FindCarmenSandiego.Properties.Resources.RedCrossRed; break;
                        case 'g': pbA25.Image = FindCarmenSandiego.Properties.Resources.RedCrossGreen; break;
                        case 'b': pbA25.Image = FindCarmenSandiego.Properties.Resources.RedCrossBlue; break;
                        default:
                            break;
                    }break;
                ...
                case 'g':
                    switch (strCrossColour[0])
                    {
                        case 'e': pbA25.Image = FindCarmenSandiego.Properties.Resources.GreenCrossEmpty; break;
                        case 'r': pbA25.Image = FindCarmenSandiego.Properties.Resources.GreenCrossRed; break;
                        case 'g': pbA25.Image = FindCarmenSandiego.Properties.Resources.GreenCrossGreen; break;
                        case 'b': pbA25.Image = FindCarmenSandiego.Properties.Resources.GreenCrossBlue; break;
                        default:
                            break;
                    }break;
                ...
                case 'b':
                    switch (strCrossColour[0])
                    {
                        case 'e': pbA25.Image = FindCarmenSandiego.Properties.Resources.BlueCrossEmpty; break;
                        case 'r': pbA25.Image = FindCarmenSandiego.Properties.Resources.BlueCrossRed; break;
                        case 'g': pbA25.Image = FindCarmenSandiego.Properties.Resources.BlueCrossGreen; break;
                        case 'b': pbA25.Image = FindCarmenSandiego.Properties.Resources.BlueCrossBlue; break;
                        default:
                            break;
                    }break;
                default:
